...
<div class="container" style="max-width:1100px; margin:24px auto;">
  ...
  <!-- Search / filter -->
  <form method="get" action="${pageContext.request.contextPath}/admin/users" class="card" style="padding:12px;display:grid;grid-template-columns:1fr 200px 120px;gap:10px;align-items:center;">
    <input type="text" name="q" value="${param.q}" placeholder="Tìm theo tên, email, username…" class="input">
  ...
  <div class="card" style="margin-top:12px;">
    ...
    <div class="table-wrap">
      <table class="table">
        <thead>
          <tr>
            <th>#</th><th>Họ tên</th><th>Email</th><th>Username</th><th>Role</th><th>Phòng ban</th><th>Trạng thái</th><th style="width:180px;">Thao tác</th>
          </tr>
        </thead>
        <tbody>
